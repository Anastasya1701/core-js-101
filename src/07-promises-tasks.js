...
function willYouMarryMe(isPositiveAnswer) {
  return new Promise((resolve, regect) => {
    if (typeof isPositiveAnswer === 'boolean') {
      const positiveText = isPositiveAnswer
        ? 'Hooray!!! She said "Yes"!' : 'Oh no, she said "No".';
      return resolve(positiveText);
    }
    const arrValue = 'Wrong parameter is passed! Ask her again.';
    return regect(new Error(arrValue));
  });
}
